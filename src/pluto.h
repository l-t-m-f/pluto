...
#define PLUTO_SCROLL_STYLE_NONE 0
#define PLUTO_SCROLL_STYLE_PROPORTIONAL 1
#define PLUTO_SCROLL_STYLE_CONSTANT 2
#define PLUTO_SCROLL_STYLE_BLEND 3
...
SDL_FPoint get_mouse_position (ecs_entity_t ent, ecs_world_t *world);
